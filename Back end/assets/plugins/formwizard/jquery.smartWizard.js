		...
		_setElements: function () {
			...
			if (this.options.errorSteps && this.options.errorSteps.length > 0) {
				$.each(this.options.errorSteps, function (i, n) {
					mi.steps.eq(n).parent("li").addClass("success ");
				});
			}
			// Hidden steps
		...
		_setToolbar: function () {
			...
			if (
				...
				btnGroupExtra = $("<div></div>")
					.addClass("btn-group mr-2 sw-btn-group-extra float-end")
					.attr("role", "group");
				$.each(
					this.options.toolbarSettings.toolbarExtraButtons,
					function (i, n) {
			...
			switch (this.options.toolbarSettings.toolbarPosition) {
				case "top":
					toolbarTop = $("<div></div>").addClass(
						" sw-toolbar sw-toolbar-top justify-content-" +
							this.options.toolbarSettings.toolbarButtonPosition
					);
				...
				case "bottom":
					toolbarBottom = $("<div></div>").addClass(
						" sw-toolbar sw-toolbar-bottom justify-content-" +
							this.options.toolbarSettings.toolbarButtonPosition
					);
			...
			if (selSteps && selSteps.length > 0) {
				switch (state) {
					...
					case "show":
						...
						break;
					case "error-on":
						$(selSteps).parents("li").addClass("success ");
						break;
					case "error-off":
						$(selSteps).parents("li").removeClass("success ");
						break;
				}
			}
		},
